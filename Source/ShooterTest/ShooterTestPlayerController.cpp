...
void AShooterTestPlayerController::BeginPlay()
{
	Super::BeginPlay();
	...
	if (ShouldUseTouchControls() && IsLocalPlayerController())
	{
		...
		if (MobileControlsWidget)
		{
			...
			UE_LOG(LogShooterTest, Error, TEXT("Could not spawn mobile controls widget."));
...
bool AShooterTestPlayerController::ShouldUseTouchControls() const
{
